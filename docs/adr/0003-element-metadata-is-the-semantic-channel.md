...
with `link` carrying the resolved, tappable address. Both fields survive the
full round-trip including a human dragging the element in the browser, which was
