...
| Visual components                                                | One Tailwind 4 shadcn/Base UI layer plus a minimal assistant-ui ThreadList, Composer, ToolFallback/ApprovalCard, and StoppedRun subset, mapped to Archboard tokens | Copied and owned source                 |
