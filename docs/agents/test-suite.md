...
- `test:serial-browser`: the 17 canonical browser owners through the strict adapter.
...
the system owner and all 17 browser owners to hosted coverage. Repository policy
...
| `test:browser`                                                                 | serial-browser     | the 17 literal owners below                                                                                          |
