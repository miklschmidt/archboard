...
export function ConflictDialog({
  conflict, hold, busy, onReload, onOverwrite, onSaveAs, onCancel
    ...
    >
      ...
      {hold && (
        <p>
          ...
          {held > 0
            ? <>The {changes(held)} drawn since then {held === 1 ? 'is' : 'are'} on this canvas
                and in nothing else, and {held === 1 ? 'it stays' : 'they stay'} there until you
                choose.</>
