...
| `flow`         | a request that asks for the exchange itself — what happens, in what order, for one request, job, interaction or startup — on a new board or an existing one; a board about the parts and their wiring owes none merely because what it draws runs in some order | a `flow` and a `data-flow` view over it                                                                                                                                                                                                                                                                                                    |
