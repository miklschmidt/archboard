---
id: TASK-143.06
title: Keep the bound Codex task current with semantic board changes
status: To Do
assignee: []
...
- [ ] #3 No bound controllable workhorse, unavailable thread link, lease loss, or child exit produces no delivery and exposes an inspectable reason. Replacement child state never inherits proof or silently resumes workhorse or coordinator delivery
