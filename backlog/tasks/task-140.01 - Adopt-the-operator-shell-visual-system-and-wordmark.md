...
- [ ] #2 Light and dark themes share one token system with the reference cobalt selection and lime status accents, accessible text and control contrast, visible focus, and no gradient or glow decoration
