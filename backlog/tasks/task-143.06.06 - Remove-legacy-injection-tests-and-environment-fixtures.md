...
All-spawn remediation plan: add one positive buildOwnedCanvasEnvironment constructor at the canonical owned-canvas support boundary. It will retain only ambient PATH, accept explicit caller fixture controls, and set owned HOME, XDG_CONFIG_HOME, XDG_STATE_HOME, TMPDIR, PORT, HOST, ARCHBOARD_VAULT, and LOG_LEVEL. Route codex-workbench-lifecycle, canvas-http-lifetime, and canvas-startup-signal real canvas spawns through it without changing their argv, specialized controls, lifecycle, or cleanup. Reuse the existing child-observed canonical owner, run all named focused owners plus static checks under containment, record unrelated typecheck failures, and leave ACs unchecked.
<!-- SECTION:PLAN:END -->
...
All-spawn remediation completed against prior HEAD c24a88b07ab508e0cb329778608596bdfec8c271. Added the shared positive buildOwnedCanvasEnvironment constructor at the canonical owned-canvas boundary and routed codex-workbench-lifecycle.ts startCanvas, canvas-http-lifetime.test.ts spawnCanvas, and canvas-startup-signal.test.ts through it. The constructor retains ambient PATH, explicit supplied fixture controls, and owned HOME, XDG_CONFIG_HOME, XDG_STATE_HOME, TMPDIR, PORT, HOST, ARCHBOARD_VAULT, and LOG_LEVEL; the three targeted launchers no longer spread process.env. Existing argv, fixture controls, Codex roots, process-group handling, lifecycle, and cleanup remain intact. Focused sequential validation through the required capped wrapper: codex-workbench-lifecycle.test.ts passed 1/1 with 74 assertions in unit archboard-task143-worker-command-7s2LPY8a.service; canvas-http-lifetime.test.ts passed 3/3 with 10 assertions in unit archboard-task143-worker-command-tDOvWlvd.service; canvas-startup-signal.test.ts passed 1/1 with 4 assertions in unit archboard-task143-worker-command-49lXB1TN.service; owned-canvas.test.ts passed 10/10 with 67 assertions in unit archboard-task143-worker-command-9mdGZiWj.service; resource-cleanup.test.ts passed 8/8 with 76 assertions in unit archboard-task143-worker-command-udoP5HhK.service; legacy-injection-removal.test.ts passed 2/2 with 5 assertions in unit archboard-task143-worker-command-i6ARoW6z.service. Focused Oxlint, Oxfmt --check, git diff --check, and no-broad-spread/no-retired-reference audits passed in unit archboard-task143-worker-command-2T6MJLJR.service and unit archboard-task143-worker-command-0OO9qerQ.service. bunx tsc --noEmit --pretty false remains red only on the documented unrelated pre-existing files: src/runtime/engine/git-process-owner.ts, src/runtime/engine/git.ts, src/runtime/engine/tests/board-lock-lease.test.ts, tests/system/board-inspection/support/package-process.ts, and tests/system/board-inspection/support/package-sentinel.ts. No broad process/system/repository/browser suite ran. Acceptance criteria remain unchecked and task remains In Progress.

All-spawn remediation final validation completed against fixed base 503bae209c970b72240489213e704de771565b77 and prior HEAD c24a88b07ab508e0cb329778608596bdfec8c271. Shared buildOwnedCanvasEnvironment now lives in the adjacent canonical owned-canvas ownership support module and is re-exported by owned-canvas.ts. It retains only ambient PATH, explicit supplied fixture values, and owned HOME, XDG_CONFIG_HOME, XDG_STATE_HOME, TMPDIR, PORT, HOST, ARCHBOARD_VAULT, and LOG_LEVEL. codex-workbench-lifecycle.ts, canvas-http-lifetime.test.ts, and canvas-startup-signal.test.ts now use it; their exact process argv, fixture controls, Codex roots, specialized lifecycle, PID/process-group handling, and cleanup remain intact. Final sequential focused validation through the required capped wrapper: codex-workbench-lifecycle.test.ts passed 1/1 with 74 assertions in unit archboard-task143-worker-command-s4Pkchnm.service; canvas-http-lifetime.test.ts passed 3/3 with 10 assertions in unit archboard-task143-worker-command-6otcxZUZ.service; canvas-startup-signal.test.ts passed 1/1 with 4 assertions in unit archboard-task143-worker-command-4dNESfKB.service; owned-canvas.test.ts passed 10/10 with 67 assertions in unit archboard-task143-worker-command-UiLpMTzo.service; resource-cleanup.test.ts passed 8/8 with 76 assertions in unit archboard-task143-worker-command-k9ILybdC.service; legacy-injection-removal.test.ts passed 2/2 with 5 assertions in unit archboard-task143-worker-command-4eZmIj0k.service. Focused Oxlint, Oxfmt --check, git diff --check, and targeted no-broad-spread/no-retired-reference audits passed in unit archboard-task143-worker-command-AnWxfvoS.service. bunx tsc --noEmit --pretty false remains red only on documented unrelated pre-existing files: src/runtime/engine/git-process-owner.ts, src/runtime/engine/git.ts, src/runtime/engine/tests/board-lock-lease.test.ts, tests/system/board-inspection/support/package-process.ts, and tests/system/board-inspection/support/package-sentinel.ts. No broad process/system/repository/browser suite ran. Acceptance criteria remain unchecked and task remains In Progress.
<!-- SECTION:NOTES:END -->
