...
import { paletteFor, type Palette } from "@/transformers/semantic-renderer/lib/theme";
import { paintArchitecture } from "@/transformers/semantic-renderer/lib/svg/architecture";
