...
export const InspectionReportSchema = z.strictObject({
	...
	preprocessingWork: z.strictObject({
		broadPhaseEvents: z.number().int().nonnegative(),
		broadPhaseActiveVisits: z.number().int().nonnegative(),
		broadPhaseExpiryPops: z.number().int().nonnegative(),
		hierarchyEvents: z.number().int().nonnegative(),
		hierarchyCandidateVisits: z.number().int().nonnegative(),
		hierarchyExpiryPops: z.number().int().nonnegative(),
		pathSegmentChecks: z.number().int().nonnegative(),
	}),
