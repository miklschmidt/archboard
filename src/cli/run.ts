...
const COMMANDS: Record<string, Command> = {
  ...
  reload: {
    handler: server.reload,
    summary: 'Re-run the canvas source in place, keeping boards, panes and sockets',
    usage: 'reload  (needs a canvas started with `bun run dev:canvas`)'
  },
