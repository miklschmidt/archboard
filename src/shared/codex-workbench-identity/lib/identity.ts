 ...
 * issuance history.
 * @param input - The identity facts persisted by the earlier process.
 * @param input.childId - The child id, as an untrusted value.
 * @param input.epoch - The epoch, as an untrusted value.
 * @returns The identity and operation authorities.
