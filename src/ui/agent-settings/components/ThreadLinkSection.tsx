...
import type { AgentSettingsBusy } from "@/ui/agent-settings/types/contracts";
import {
	describeCandidate,
	describeThreadLink,
	threadLinkFacts,
} from "@/ui/agent-settings/lib/presentation";
import { SectionHeading } from "@/ui/agent-settings/components/SectionHeading";
import { StateBadge } from "@/ui/agent-settings/components/StateBadge";
...
import { BusyText, DialogErrorAlert, Facts, Technical, type DialogError } from "@/ui/dialog-parts";
