...
const EXPECTED_CLASSES = {
	primary:
		"inline-flex shrink-0 items-center justify-center gap-control whitespace-nowrap rounded-control border font-sans !text-control font-medium shadow-flat outline-none select-none transition-colors duration-control ease-control data-disabled:cursor-default data-disabled:opacity-disabled-control focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring [&_svg]:pointer-events-none [&_svg]:shrink-0 border-primary bg-primary text-primary-foreground hover:not-data-disabled:bg-primary-hover min-h-touch-target px-control-inline py-control",
	secondary:
		"inline-flex shrink-0 items-center justify-center gap-control whitespace-nowrap rounded-control border font-sans !text-control font-medium shadow-flat outline-none select-none transition-colors duration-control ease-control data-disabled:cursor-default data-disabled:opacity-disabled-control focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring [&_svg]:pointer-events-none [&_svg]:shrink-0 border-border bg-surface-subtle text-foreground hover:not-data-disabled:bg-surface-hover min-h-touch-target px-control-inline py-control",
	quiet:
		"inline-flex shrink-0 items-center justify-center gap-control whitespace-nowrap rounded-control border font-sans !text-control font-medium shadow-flat outline-none select-none transition-colors duration-control ease-control data-disabled:cursor-default data-disabled:opacity-disabled-control focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring [&_svg]:pointer-events-none [&_svg]:shrink-0 border-transparent bg-transparent text-foreground hover:not-data-disabled:border-border hover:not-data-disabled:bg-surface-hover min-h-touch-target px-control-inline py-control",
} as const;
