...
import type { ConflictDialogProps } from "@/ui/board-dialogs/types/contracts";
import {
	AlertDialog,
	AlertDialogCancel,
	AlertDialogContent,
...
import { BusyText, DialogErrorAlert, Facts, Technical, type FactRow } from "@/ui/dialog-parts";
