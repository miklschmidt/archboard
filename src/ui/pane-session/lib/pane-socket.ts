...
function createPaneSocketConnector(
	...
	let registration: PaneRegistrationLatch | null = null;
	...
	function connect(): void {
		...
		const next: PaneSocketGeneration = {
			socket,
			generation,
			registration: createPaneRegistrationLatch(socket, generation),
		};
		current = next;
	 ...
	 */
	function currentRegistration(): PaneRegistrationLatch | null {
		return registration;
	}
