...
export function InstallLibraryDialog({
	...
	onConfirm,
	onCancel,
}: InstallLibraryDialogProps): React.JSX.Element {
	return (
		<Modal
		...
		>
			...
			<p className="hint">
				They join the library on this canvas server, so every pane and every tab gets them, and they
				stay until you delete them. Nothing is drawn on the board until you drag one onto it.
			</p>
		</Modal>
	);
}
