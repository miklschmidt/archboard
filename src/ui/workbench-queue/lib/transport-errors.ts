...
/**
 * The message of a thrown value, or a fallback for a non-error.
 * @param error The thrown value.
 * @param fallback The words when nothing was thrown as an error.
 * @returns The message.
 */
...
export { errorMessage, transportErrorFacts };
